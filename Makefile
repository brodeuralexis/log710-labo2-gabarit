...
# Par convention, les fichiers GNUMakefile devraient fournir une règle &clean*
...
#
# Cette information est réutilisé et mise-à-jour à chaque compilation du code
# afin de déterminer les dépendances directement et transitives des entêtes.
#
