#ifndef __LOG710__HYBRID_SCHEDULER__
#define __LOG710__HYBRID_SCHEDULER__
...
#define NUM_HYBRID_PRIORITIES 4

/// FWD: process.h
typedef struct process process_t;

/**
 * @brief La structure de données contenant les informations de l'ordonnanceur
 * hybride.
 */
typedef struct hybrid_scheduler
{
    /**
     * @brief Les files de prioritées de cet ordonnanceur.
     */
    queue_t priorities[NUM_HYBRID_PRIORITIES];
    /**
